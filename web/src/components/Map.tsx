  ...
  return (
    ...
    >
      ...
      <GeolocateControl
        ...
        showUserLocation
        showAccuracyCircle
        // Trigger generic auto-location if possible, or reliance on trackUserLocation
        // Note: i18n commented out as it caused issues in original code
      />
