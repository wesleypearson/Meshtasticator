...
import { SimulationTool } from "@app/components/PageComponents/Map/Tools/SimulationTool.tsx";
...
import { Filter, LocateFixedIcon } from "lucide-react";
import {
  useCallback,
  useDeferredValue,
  useId,
...
const MapPage = () => {
  ...
  console.log("MapPage rendered. Valid nodes:", validNodes.length);
  ...
  return (
    <PageLayout label="Map" noPadding actions={[]} leftBar={<Sidebar />}>
      ...
      <div className="flex flex-col space-y-1 fixed top-36 right-2.5 z-50">
        ...
        <FilterControl
          ...
          parameters={{
            ...
            triggerIcon: <Filter className="w-[21px]" />,
            showTextSearch: true,
          }}
        />
